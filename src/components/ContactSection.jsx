...
export const ContactSection = () => {
  ...
  return (
    <section id="contact" className="pt-24 pb-0 px-4 bg-secondary/30">
          ...
          <div className="space-y-8">
            ...
            <div className="pt-10">
              ...
              <div className="flex justify-center gap-6 text-2xl text-muted-foreground">
                <a
                  href="https://www.linkedin.com/in/prince-kushwah-a2640b306?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                  target="_blank"
                ...
                <a
                  href="https://leetcode.com/u/Npa6duKmie/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-primary"
                >
                ...
                <a
                  href="https://www.geeksforgeeks.org/profile/princeczu3d"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-primary"
                >
